...
interface MessageInputProps {
  ...
  handleMessageSend: (e: React.FormEvent<HTMLFormElement> | React.KeyboardEvent<HTMLInputElement>, imageFile?: File | null) => void;
        ...
        className='flex flex-col gap-2 border-t border-gray-700 pt-2'>
        {
          imageFile && <div className='relative w-fit'>
            ...
            <button type='button' className='absolute -top-2 -right-2 bg-black rounded-full p-1'
              onClick={() => setImageFile(null)}><X className='w-4 h-4 text-white' /></button>
          </div>
        }
        <div className='flex items-center gap-2'>
          <label className='cursor-pointer bg-gray-700 hover:bg-gray-600 rounded-lg px-3
          ...
          className='bg-blue-500 hover:bg-blue-600 text-white rounded-lg px-4 py-2 transition-colors disabled:cursor-not-allowed'>
          {
